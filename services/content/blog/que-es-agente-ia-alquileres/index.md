...
Para más detalles técnicos sobre el agente, consulta la [documentación del agente IA](/documentation/agente-ia) y la [referencia de herramientas MCP](/documentation/herramientas).
